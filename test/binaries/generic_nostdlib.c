...
void calc() {
    print("Calculator!");
    int a = string_to_int(input_prompt("First number: "));
    char * op = input_prompt("Operation (+, -, *, /): ");
    int b = string_to_int(input_prompt("Second number: "));
    int res;
    switch (op[0]) {
        case '+': res = a + b; break;
        case '-': res = a - b; break;
...
void calc_bitwise() {
    ...
    unsigned a = string_to_int(input_prompt("First number: "));
    char * op = input_prompt("Operation (&, |, ^): ");
    unsigned b = string_to_int(input_prompt("Second number: "));
...
int _start() {
    ...
    print("Your number is ", int_to_string(n));
    print("Your number negated is ", int_to_string(-n));
    print("Your number doubled is ", int_to_string(n * 2));
    calc();
    calc_bitwise();
